...
* Use [issues](https://github.com/pe2mbs/flask-redis-multi/issues) to report bugs and features
...
* This package is distributed under the [GPL2-only](LICENSE).
...
1. Clone the repository
    ...
    ```sh
    git clone https://github.com/pe2mbs/flask-redis-multi.git
    cd flask-redis-multi
    ```
